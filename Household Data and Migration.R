setwd("G:/Data Works GitHub/Decoding Household Data")

#Only to install if not already.
...
#Mapping the absentee in Nepal
#code column will combine psu and hhld to give unique identifier for each household 
...
#Number 1 denotes for job, 4 for looking job we will use that in logistic model
